...
uses
  ...
  private
    k: integer;             {счЄтчик количества решений}
    board: TBoard;          {собственно доска, тип объ€влен в модуле Stacks}
    S: pStack;              {собственно указатель на стек. тип объ€влен в модуле Stacks}
    ...
    function GetFreeBoard: TBoard;      {функци€ возвращает полностью пустую доску}
...
//аналогична€ процедура с использваонием очереди будет более приемлемой
var
	copy: TBoard;
begin
